      ...
      {user?.role === "employer" && (
        <div className="flex justify-center mb-12 animate-fade-in-up">
          <input
            ...
            className="w-full max-w-xl px-5 py-3 border border-green-300 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 transition-all text-sm"
          />
        </div>
      )}
          ...
          filteredUsers.map((userdetails, index) => (
            ...
            >
              ...
              <Link
                ...
                className="inline-block mt-5 px-5 py-2 rounded-md bg-gradient-to-r from-green-500 to-green-600 text-white font-medium shadow hover:shadow-lg hover:from-green-600 hover:to-green-700 transition-all duration-300"
              >
                View Profile
              </Link>
            </div>
